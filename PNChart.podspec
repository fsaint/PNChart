Pod::Spec.new do |s|
  s.name         = "PNChart"
  s.version      = "0.2.2"
  s.summary      = "A simple and beautiful chart lib with animation used in Piner for iOS (fsaint mod)"

  s.homepage     = "https://github.com/PNChart/PNChart"
  ...
  s.platform     = :ios, '6.0'
  s.source       = { :git => "https://github.com/PNChart/PNChart.git", :tag => s.version.to_s }
